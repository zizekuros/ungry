/*
  # Remove deleted_at check from subscription limit checker

  The shopping_lists table doesn't have a deleted_at column (uses hard deletion)
  So we just count all lists without checking deleted_at
*/

-- Recreate the function without deleted_at check
